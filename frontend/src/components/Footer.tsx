  ...
  return (
    ...
    >
      ...
      <div className="text-right text-sm text-gray-500 font-medium mb-3 px-6">
        Made with love by <span className="hover:text-gray-300 transition-colors hover:underline">
          <a href="https://izuaba.xyz" target="_blank" rel="noopener noreferrer">Kaycee</a>
        </span>
      </div>
    </motion.footer>
  );
